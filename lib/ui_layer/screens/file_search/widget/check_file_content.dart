...
class CheckFileDetailContentView extends StatefulWidget {
  ...
  @override
  State<CheckFileDetailContentView> createState() => _CheckFileDetailContentViewState();
}

class _CheckFileDetailContentViewState extends State<CheckFileDetailContentView> {
...
class _ContactViewState extends State<_ContactView> {
  ...
  Future<void> _pay() async {
    MyToast.showLoading();
    final result = await _domain.reqGetPostURL(id: widget.data.id ?? 0, requestType: 2);
