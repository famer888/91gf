...
///连载界面
class NovelUpdatingContent extends StatefulWidget {

  const NovelUpdatingContent({super.key});

  @override
  State<NovelUpdatingContent> createState() => _NovelUpdatingContentState();
}

class _NovelUpdatingContentState extends State<NovelUpdatingContent> {
  ...
  Future<List<NovelItemsModel>?> _getData(
    ...
    final result = await _domain.novelUpdatingList(
        page: page,
        limit: pageSize
    );
