...
///完结界面
class NovelEndContent extends StatefulWidget {

  const NovelEndContent({super.key});

  @override
  State<NovelEndContent> createState() => _NovelEndContentState();
}

class _NovelEndContentState extends State<NovelEndContent> {
  ...
  Future<List<NovelItemsModel>?> _getData(
    ...
    final result = await _domain.novelEndList(
        page: page,
        limit: pageSize
    );
