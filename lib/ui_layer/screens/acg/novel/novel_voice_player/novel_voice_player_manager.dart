...
import 'package:jygf/ui_layer/screens/acg/novel/novel_voice_player/widget/novel_voice_player_draggable.dart';
...
class NovelVoicePlayerManager {
  ...
  //生成随机索引
  int _getRandomIndex() {
    final list = NovelVoicePlayerManager.instance.voices;
    final random = Random();
  ...
  Future<void> buyVoice(VoiceModel model) async {
    ...
    if (res.isValid) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        NovelVoicePlayerManager.instance.initVideoPlayer(model, context!);
