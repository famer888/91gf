...
class CartoonNewContent extends StatefulWidget {
  const CartoonNewContent({super.key});

  @override
  State<CartoonNewContent> createState() => _CartoonNewContentState();
}

class _CartoonNewContentState extends State<CartoonNewContent> {
