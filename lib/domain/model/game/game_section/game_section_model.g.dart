...
_$GameSectionGameModelImpl _$$GameSectionGameModelImplFromJson(
    ...
    _$GameSectionGameModelImpl(
      ...
      (json['items'] as List<dynamic>)
          ...
          .toList(),
      $type: json['game_type'] as String?,
    );

Map<String, dynamic> _$$GameSectionGameModelImplToJson(
        _$GameSectionGameModelImpl instance) =>
    <String, dynamic>{
      'title': instance.title,
      'value': instance.value,
      'items': instance.items,
      'game_type': instance.$type,
    };

_$GameSectionAdModelImpl _$$GameSectionAdModelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$GameSectionAdModelImplToJson(
        _$GameSectionAdModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'title': instance.title,
