...
class _AnalyticsBottomNavWrapperState
  ...
  /// 根据横坐标、容器宽度和文字方向解析 tab 索引并上报埋点。
  ///
  /// 通过 [SchedulerBinding.addPostFrameCallback] 在渲染完成后上报
  /// [AppPageViewEvent]（含来路 key）和 [NavigationEvent]，
  /// pageLoadTime 反映从点击到渲染完成的真实耗时，与 [PageLifecycleObserver] 保持一致。
