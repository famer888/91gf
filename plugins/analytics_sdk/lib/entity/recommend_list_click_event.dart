...
/// 推荐引擎列表点击事件（服务端/客户端）
class RecommendListClickEvent {
  /// 事件类型（固定）
  final String event = EventType.recommendListClick.event;

  /// 去重 ID（动态计算）
  late final String eventId;

  /// 页面标识：page_home(首页), page_user(我的), page_video(视频页)等
  ...
  factory RecommendListClickEvent.fromJson(Map<String, dynamic> json) {
    ...
    return RecommendListClickEvent(
